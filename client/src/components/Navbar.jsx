  ...
  return (
    ...
    >
      ...
      >
        ...
        {user && <button className="border border-gray-300 px-6 py-2 text-sm font-medium rounded-full cursor-pointer transition-all hover:bg-gray-100" onClick={()=> navigate('/owner')}>
          Dashboard
        </button>
        }
